                ...
                <div className="bg-glass1 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-2xl mobile-padding">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-white/60 text-sm mb-2">
                                Опишите подробно, где вы работаете, и укажите адрес каждого офиса, контакты, район города, в котором расположен.
                            </p>
                            <p className="text-white/50 text-xs mb-3 italic">
                                Москва, ул. Колчакова, дом 25, офис 15, 8 800 500 00 00<br />
                                Краснодар, ул. Ставропольская 204, 8 800 760 00 00
                            </p>
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-2 text-white">
                                Опишите подробно перечень работ которые можете предоставить <span className="text-red-400">*</span>
                            </label>
                            <p className="text-white/60 text-sm mb-2">
                                Дополнительно укажите работаете стандартно или готовы к сложным дизайнерским задумкам и элементам
                            </p>
                            <p className="text-white/50 text-xs mb-3 italic">
                                Например: Выполняем ремонты любой сложности с самыми хитрыми дизайнерскими элементами / или/ Выполняем стандартные ремонты среднего сегмента
                            </p>
                            <textarea
                                name="work_list"
                        ...
                        <div>
                            ...
                            <p className="text-white/60 text-sm mb-2">
                                Опишите подробно, как осуществляется взаимодействие, доставка, оплата и коммуникация. Какие дополнительные расходы ложатся на плечи заказчика.
                            </p>
                            <p className="text-white/50 text-xs mb-3 italic">
                        ...
                        <div>
                            ...
                            <p className="text-white/50 text-xs mb-3 italic">
                                Например: Гарантии на сантехнику 2 года / Гарантии на все виды работ 1 год
                            </p>
                            <textarea
                                name="guarantees"
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-2 text-white">
                                Условия работы с дизайнерами и/или поставщиками. <span className="text-red-400">*</span>
                            </label>
                            <p className="text-white/60 text-sm mb-2">
                                Укажите:<br />
                            ...
                            <p className="text-white/50 text-xs mb-3 italic">
                                Например: Благодарность за рекомендацию 10% от чистой прибыли.<br />
                                Для фиксации клиента направьте нам адрес и его ФИ, контактный телефон и адрес объекта. При согласовании с заказчиком мы можем самостоятельно с ним связаться.
                            </p>
                            <textarea
