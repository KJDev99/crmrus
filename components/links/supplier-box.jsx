            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-glass1 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-2xl mobile-padding">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-2 text-white">
                        Анкета участника: роль — Поставщик.
                    </h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-white/60 text-sm mb-2">
                                Начните с перечня ассортимента. Какие бренды вы представляете? Являетесь ли вы производителем? Какие товары входят в ваш ассортимент?
                            </p>
                            <p className="text-white/50 text-xs mb-3 italic">
                                Например:<br />
                                1. Ковры:   <br />
                                Представляем ковры собственного бренда и ведущих производителей. Более 300 моделей — от классических до современных.   <br />
                                Бренды: "LuxCarpet" (ручной работы), "Kashan", "Persian Royal", "Mohawk", "Tufenkian".   <br />
                                Типы: ковры из шерсти и шелка, абстракции, визитные и офисные коврики. <br /> <br />

                                2. Свет:  <br />
                                Более 2500 моделей светильников от российских и европейских брендов для разных интерьеров.   <br />
                                Производители: "СветТех", "ЛюстраСтрой", "Artemide", "Louis Poulsen", "Lodes", "Kreon".  <br />
                                Типы: потолочные, настенные, люстры (до 5 м), встраиваемые, уличные светильники. <br /> <br />

                                3. Декор:  <br />
                                Элементы для классических и современных интерьеров.  <br />
                                Продукция: гипсовые панели, статуэтки, зеркала, ковка, картины и текстиль.  <br />
                                Бренды: "ArtGips", "DesignGips", "Elitis", "Dior Home". <br /><br />
                        ...
                        <div>
                            ...
                            <p className="text-white/60 text-sm mb-2">
                                Расскажите, сколько лет вы работаете на рынке, о ваших достижениях и уникальном торговом предложении (УТП). <br />
                                Эта информация будет добавлена в приветственный блок вашей карточки.

                            </p>
                            <p className="text-white/50 text-xs mb-3 italic">
                                Например:<br />
                                Компания «Линия Дверей» работает на рынке с 2010 года, уже более 15 лет радуя наших клиентов качественными товарами и доступными ценами. Мы получили премию (название). <br />
                                Благодаря собственным складам и транспорту, мы можем предложить самые привлекательные цены на рынке, так как отсутствуют затраты на аренду торговых площадей. В нашем салоне комплект двери обойдется всего от 5000 рублей (можно описать комплект).
                        ...
                        <div>
                            ...
                            <p className="text-white/60 text-sm mb-2">
                                Опишите, как и в какие сроки осуществляется доставка товара  <br />
                            ...
                            <p className="text-white/50 text-xs mb-3 italic">
                                Например:<br />
                                Основная часть продукции находится в наличии и доставляется в течение 2–3 дней.   <br />
                                Итальянские коллекции поставляются под заказ, срок доставки составляет 2–3 месяца.
                        ...
                        <div>
                            ...
                            <p className="text-white/60 text-sm mb-3">
                                Заполняя настоящую форму, я даю согласие на обработку, хранение, использование и передачу моих персональных данных в рамках проекта «Рейтинг Профи», в том числе на их отображение в личныом кабинете участника и использование другими участниками для профессионального взаимодействия внутри сообщества. <br />
