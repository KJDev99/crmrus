                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="text-left text-white text-sm grid grid-cols-16">
                                        ...
                                        <th className="col-span-4 pb-4 px-4 text-[18px] font-normal leading-[100%] border-b border-white tracking-normal">
                                    ...
                                    {data.length === 0 ? (
                                        ...
                                        data.map((row, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="overflow-hidden col-span-4 h-20 flex items-center px-4 font-normal text-[16px] leading-[100%] tracking-normal border-b border-white/30">
                                                ...
                                                <td className="overflow-hidden col-span-3 h-20 flex items-center px-4 font-normal text-[16px] leading-[100%] tracking-normal not-italic border-b border-white/30">
