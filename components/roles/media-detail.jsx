            ...
            <div className="max-w-xl mx-auto space-y-4 max-md:space-y-3 max-md:mt-2">
                <div className="">
                    <div className="flex mb-0">
                        ...
                        <div className="flex flex-col border-b border-b-[#FFFFFF91] pl-12 ml-[-16px] flex-grow max-md:pl-8 relative">
                    ...
                    <div className='mt-0'>
                        <div className='flex border-b border-[#FFFFFF91]'>
                            <button className={`px-4 py-2 text-center text-[19px] text-[#FFFFFF] transition-all border-r`}>
                                О компании
                            </button>
                            <button className={`flex-1 py-2 text-center text-[19px] text-[#FFFFFF] transition-all`}>
                            </button>
                        </div>
                        ...
                        <div className='space-y-4 max-md:space-y-2'>
                            {questionnaire.representative_cities && (
                                <div className='text-[#FFFFFF] px-2 py-2 border-b border-[#FFFFFF91]'>
                                    <span className='text-[19px] uppercase pr-1'>Города представительств:</span>
                                    {renderExpandableContent(questionnaire.representative_cities, 'representative_cities')}
                                </div>
                            )}
                            {questionnaire.business_form && (
                                <div className='text-[#FFFFFF] px-2 py-2 border-b border-[#FFFFFF91]'>
                                    <span className='text-[19px] uppercase pr-1'>Форма бизнеса:</span>
                                    <span>
                        ...
                        <h2 className='mt-4 text-[19px] uppercase text-[#FFFFFF] px-2'>Социальные сети:</h2>
                        <div className='space-y-4 max-md:space-y-2'>
                            {questionnaire.other_contacts && questionnaire.other_contacts.length > 0 ? (
                                <div className='text-[#FFFFFF] px-2 py-2 space-y-2 border-b border-[#FFFFFF91]'>
                                    {questionnaire.other_contacts.map((contact, index) => {
                                        try {
                                            ...
                                            return (
                                                <a target='_blank' href={value} key={index} className='text-sm h-6 overflow-hidden line-clamp-1 flex'>
                        ...
                        {questionnaire.additional_info && (
                            <>
                                <h2 className='mt-4 text-[19px] uppercase text-[#FFFFFF] px-2'>Дополнительная информация:</h2>
                                <div className='text-[#FFFFFF] px-2 py-2 border-b border-[#FFFFFF91]'>
                        ...
                        <div className='mt-0 text-[#FFFFFF] px-2 py-4 border-b border-[#FFFFFF91]'>
                            ...
                            >
                                <h3 className='text-[19px] font-normal uppercase'>ОТЗЫВЫ:</h3>
